  ...
  class Build < CommitStatus
    ...
    def predefined_variables
      Gitlab::Ci::Variables::Collection.new.tap do |variables|
        ...
        variables.append(key: 'CI_SERVER_VERSION_MAJOR', value: Gitlab::SEMANTIC_VERSION.major.to_s)
        variables.append(key: 'CI_SERVER_VERSION_MINOR', value: Gitlab::SEMANTIC_VERSION.minor.to_s)
        variables.append(key: 'CI_SERVER_VERSION_PATCH', value: Gitlab::SEMANTIC_VERSION.patch.to_s)
        variables.append(key: 'CI_SERVER_VERSION_PRERELEASE', value: Gitlab::SEMANTIC_VERSION.pre)
