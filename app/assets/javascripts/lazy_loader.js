...
export default class LazyLoader {
  ...
  throttledElementsInView = _.throttle(() => this.checkElementsInView(), 300);
  throttledScrollCheck = _.throttle(() => this.scrollCheck(), 300);
  debouncedElementsInView = _.debounce(() => this.checkElementsInView(), 300);
