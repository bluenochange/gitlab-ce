...
| **CI_SERVER_VERSION_MAJOR**     | all    | all    | GitLab version major component |
| **CI_SERVER_VERSION_MINOR**     | all    | all    | GitLab version minor component |
| **CI_SERVER_VERSION_PATCH**     | all    | all    | GitLab version patch component |
| **CI_SERVER_VERSION_PRERELEASE**| all    | all    | GitLab version prerelease component |
...
++ export CI_SERVER_VERSION_PRERELEASE=
